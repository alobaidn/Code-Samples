    ...
    throws ServletException, IOException
  {
    ...
    for(int i = arrSize; i >= 0; i--) 
    {
      ...
      if(username.equals(predArr.get(i).getUser())) {
        ...
        out.println("<form method='post' name='deletePred' action='http://cs.gmu.edu:8080/uprapham/servlet/HLVoting.Delete'>");
        ...
        out.println("<form method='post' name='voteform' action='http://cs.gmu.edu:8080/uprapham/servlet/HLVoting.Vote' onSubmit='return voteValidate(this);'>\n");
    ...
    out.print("action='http://cs.gmu.edu:8080/uprapham/servlet/HLVoting.Reset'>");
    ...
    out.print("<a href='http://cs.gmu.edu:8080/uprapham/HLVoting/index.jsp'>");
